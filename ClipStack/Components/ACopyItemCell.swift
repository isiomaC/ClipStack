...
//  ClipStack
//
//  Created by Chuck on 19/06/2022.
...
class ACopyItemCell: UICollectionViewCell{
...
//        label.topAnchor.constraint(equalTo: date.bottomAnchor, constant: 20).isActive = true
        ...
        label.widthAnchor.constraint(equalTo: contentView.widthAnchor, constant:  -30).isActive = true
